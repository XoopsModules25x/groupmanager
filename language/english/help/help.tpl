<div id="help-template" class="outer">
    <{include file=$smarty.const._MI_GROUPS_HELP_HEADER}>

    <h4 class="odd">DESCRIPTION</h4> <br>

    <p class="even">This module allows you to easily add or remove users from groups.<br> <br>

        It also allows you to set which group can change each others users, through XOOPS permissions.<br> <br>
    </p>
